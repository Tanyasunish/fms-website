...
export const UPCOMING_EVENTS: readonly UpcomingEvent[] = [
  { id: 'event-teens-jeremiah-2026', day: '19', month: 'MAY', title: 'Teens – Jeremiah 2026', loc: 'Zion Retreat Centre' },
  { id: 'event-kids-samuel-2026', day: '26', month: 'MAY', title: 'Kids – Samuel 2026', loc: 'Zion Retreat Centre' },
  { id: 'event-couples-elkanah-hannah', day: '22', month: 'MAY', title: 'Couples – Elkanah Hannah', loc: 'Zion Retreat Centre' },
];
...
export const FORMATION_EVENTS: readonly FormationEvent[] = [
  ...
  { id: 'pilgrimage-holyland-2026', title: 'Holy Land Pilgrimage 2026', date: 'October 12, 2026', loc: '10 Days Sacred Travel' },
];
